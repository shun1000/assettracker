...
(function(global, factory) {
  "object" === typeof exports && "undefined" !== typeof module
    ? factory(exports)
    : "function" === typeof define && define.amd ? define(["exports"], factory) : factory((global.ScanditSDK = {}));
  ...
  (function(CameraAccess) {
    ...
    function getCameras() {
      return new _Promise(function(resolve, reject) {
        var unsupportedBrowserError = exports.BrowserHelper.checkBrowserCompatibility();
    ...
    _createClass(ScanSettings, [
      {
        ...
        value: function toJSONString() {
          ...
          _Object$keys(this.symbologySettings).forEach(function(s) {
            symbologies[exports.Barcode.Symbology.toJSONName(s)] = _this.symbologySettings[s];
          });
      ...
      },
      {
        ...
        value: function getSymbologySettings(symbology) {
          ...
          if (this.symbologySettings.hasOwnProperty(ls)) return this.symbologySettings[ls];
            ...
            this.symbologySettings[ls] = new exports.SymbologySettings();
          ...
          if ("object" === ("undefined" === typeof symbology ? "undefined" : _typeof(symbology))) {
            ...
            try {
              for (
                ...
                if (s in exports.Barcode.Symbology || -1 !== _Object$values(exports.Barcode.Symbology).indexOf(ls))
                  if (this.symbologySettings.hasOwnProperty(ls)) this.symbologySettings[ls].setEnabled(enabled);
                  else this.symbologySettings[ls] = new exports.SymbologySettings({ enabled: enabled });
              }
            } catch (err) {
            ...
            if (symbology in exports.Barcode.Symbology || -1 !== _Object$values(exports.Barcode.Symbology).indexOf(_ls))
              if (this.symbologySettings.hasOwnProperty(_ls)) this.symbologySettings[_ls].setEnabled(enabled);
              else this.symbologySettings[_ls] = new exports.SymbologySettings({ enabled: enabled });
          }
          return this;
        }
      }
        ...
        value: function processImage(imageData) {
          ...
          return new _Promise(function(resolve, reject) {
            ...
            _this.eventEmitter.once(workResultEvent, function(result) {
              ...
              resolve({ barcodes: result.map(exports.Barcode.createFromWASMResult) });
            });
    ...
    _createClass(BarcodePickerCameraManager, [
        ...
        value: function resolveInitializeCamera(camera, resolve, reject) {
          ...
          if (BarcodePickerCameraManager.isIOSDevice)
            this.barcodePicker.videoElement.onloadstart = function() {
              ...
              _this5.barcodePicker.setMirrorImageEnabled(_this5.activeCamera.cameraType === exports.Camera.Type.FRONT);
            ...
            this.barcodePicker.videoElement.onloadeddata = function() {
              ...
              if (
                ...
                _this5.activeCamera = camera;
                _this5.barcodePicker.setMirrorImageEnabled(
                  _this5.activeCamera.cameraType === exports.Camera.Type.FRONT
                );
      ...
      },
      {
        ...
        value: function setupCameraSwitcher() {
          ...
          this.cameraSwitcherElement.className = exports.BarcodePicker.cameraSwitcherElementClassName;
                ...
                .then(function(cameras) {
                  var newCameraIndex =
                    (cameras.findIndex(function(camera) {
                      return (
                        camera.deviceId ===
                        (null == _this6.activeCamera ? camera.deviceId : _this6.activeCamera.deviceId)
                      );
                    }) +
                      1) %
                    cameras.length;
      ...
      },
      {
        ...
        value: function setupTorchToggle() {
          ...
          this.torchToggleElement.className = exports.BarcodePicker.torchToggleElementClassName;
          this.torchToggleElement.classList.add("scandit-hidden");
          ...
          value: function setupVideoElement(videoElement) {
            ...
            videoElement.addEventListener("canplay", function() {
              if (null != _this2.cameraManager.activeCamera) {
                ...
                _this2.videoImageCanvasContext.canvas.height =
                  _this2.cameraManager.activeCamera.currentResolution.height;
  ...
  exports.BarcodePicker.grandParentElementClassName = "scandit scandit-container";
  exports.BarcodePicker.parentElementClassName = "scandit scandit-barcode-picker";
  exports.BarcodePicker.videoElementClassName = "scandit-video";
  exports.BarcodePicker.scanditLogoImageElementClassName = "scandit-logo";
  exports.BarcodePicker.laserImageElementClassName = "scandit-laser";
  exports.BarcodePicker.viewfinderElementClassName = "scandit-viewfinder";
  exports.BarcodePicker.cameraSwitcherElementClassName = "scandit-camera-switcher";
  exports.BarcodePicker.torchToggleElementClassName = "scandit-torch-toggle";
