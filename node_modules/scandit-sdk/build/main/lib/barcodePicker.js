...
const barcodePickerCameraManager_1 = require("./barcodePickerCameraManager");
 ...
 */
class BarcodePicker {
    constructor(originElement, { visible, playSoundOnScan, vibrateOnScan, scanningPaused, guiStyle, scanSettings } = {}) {
     ...
     */
    static create(originElement, { visible = true, playSoundOnScan = false, vibrateOnScan = false, scanningPaused = false, 
    /**
     * @hidden
     * @deprecated
     */
    uiStyle, guiStyle = uiStyle != null ? uiStyle : BarcodePicker.GuiStyle.LASER, scanSettings = new scanSettings_1.ScanSettings(), enableCameraSwitcher = true, enableTorchToggle = true, enableTapToFocus = true, accessCamera = true, camera, cameraSettings } = {}) {
