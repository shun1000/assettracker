...
export class ScanSettings {
    ...
    toJSONString() {
        ...
        Object.keys(this.symbologySettings).forEach(s => {
            symbologies[Barcode.Symbology.toJSONName(s)] = this.symbologySettings[s];
        });
        const isFullSearchArea = Math.round(this.searchArea.x * 100) === 0 &&
    ...
    getSymbologySettings(symbology) {
        const ls = symbology.toLowerCase();
