		...
		<li class="current tsd-kind-class tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-enum tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="../enums/parser.dataformat.html" class="tsd-kind-icon">Data<wbr>Format</a>
				</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				...
				<p>The parser is created through <a href="barcodepicker.html#createparserforformat">BarcodePicker.createParserForFormat</a> or <a href="scanner.html#createparserforformat">Scanner.createParserForFormat</a>.
				Note that you need to have a valid license with the parsing feature enabled to use the parser functionalities.</p>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-enum tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="../enums/parser.dataformat.html" class="tsd-kind-icon">Data<wbr>Format</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="parser.html#parserawdata" class="tsd-kind-icon">parse<wbr>Raw<wbr>Data</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="parser.html#parsestring" class="tsd-kind-icon">parse<wbr>String</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="parser.html#setoptions" class="tsd-kind-icon">set<wbr>Options</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">parse<wbr>Raw<wbr>Data<span class="tsd-signature-symbol">(</span>dataRaw<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Uint8Array</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/parserresult.html" class="tsd-signature-type">ParserResult</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/parser.ts:52</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Process the given raw data with the parser, retrieving the result as a <a href="../interfaces/parserresult.html">ParserResult</a> object.</p>
							</div>
							<p>Multiple requests done without waiting for previous results will be queued and handled in order.</p>
							<p>If parsing of the data fails the returned promise is rejected with a <tt>ScanditEngineError</tt> error.</p>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>dataRaw: <span class="tsd-signature-type">Uint8Array</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The raw data to be parsed.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/parserresult.html" class="tsd-signature-type">ParserResult</a><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">parse<wbr>String<span class="tsd-signature-symbol">(</span>dataString<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/parserresult.html" class="tsd-signature-type">ParserResult</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/parser.ts:73</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>dataString: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/parser.ts:38</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
