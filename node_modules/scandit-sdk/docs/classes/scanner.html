...
<head>
	...
	<title>Scanner | Scandit Barcode Scanner SDK for the Web</title>
		...
		<li class="current tsd-kind-class tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#applyimagesettings" class="tsd-kind-icon">apply<wbr>Image<wbr>Settings</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#applyscansettings" class="tsd-kind-icon">apply<wbr>Scan<wbr>Settings</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#createparserforformat" class="tsd-kind-icon">create<wbr>Parser<wbr>For<wbr>Format</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#destroy" class="tsd-kind-icon">destroy</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#isbusyprocessing" class="tsd-kind-icon">is<wbr>Busy<wbr>Processing</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#isready" class="tsd-kind-icon">is<wbr>Ready</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#onready" class="tsd-kind-icon">on<wbr>Ready</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scanner.html#processimage" class="tsd-kind-icon">process<wbr>Image</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A low-level scanner interacting with the external Scandit Engine library.
					Used to set up scan / image settings and to process single image frames.</p>
				</div>
				<p>The loading of the external Scandit Engine library can take some time, the <a href="scanner.html#onready">onReady</a> method
					can be used to set up a listener function to be called when the library is loaded and the <a href="scanner.html#isready">isReady</a> method
				can return the current status. The scanner will be ready to start scanning when the library is loaded.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">Scanner</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="scanner.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#applyimagesettings" class="tsd-kind-icon">apply<wbr>Image<wbr>Settings</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#applyscansettings" class="tsd-kind-icon">apply<wbr>Scan<wbr>Settings</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#createparserforformat" class="tsd-kind-icon">create<wbr>Parser<wbr>For<wbr>Format</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#destroy" class="tsd-kind-icon">destroy</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#isbusyprocessing" class="tsd-kind-icon">is<wbr>Busy<wbr>Processing</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#isready" class="tsd-kind-icon">is<wbr>Ready</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#onready" class="tsd-kind-icon">on<wbr>Ready</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scanner.html#processimage" class="tsd-kind-icon">process<wbr>Image</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Scanner<span class="tsd-signature-symbol">(</span>__namedParameters<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scanner.html" class="tsd-signature-type">Scanner</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:32</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a Scanner instance.</p>
							</div>
							...
							<p>Before processing an image the relative settings must also have been set.</p>
							<p>If the library has not been correctly configured yet a <tt>LibraryNotConfiguredError</tt> error is thrown.</p>
							<p>If a browser is incompatible a <tt>UnsupportedBrowserError</tt> error is thrown.</p>
						</div>
							...
							<li>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter">
										<h5>image<wbr>Settings<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><a href="../modules/imagesettings.html" class="tsd-signature-type">ImageSettings</a></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;undefined</div>
											The configuration object to define the properties of an image to be scanned.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										...
										<div class="tsd-comment tsd-typography">
											...
											The configuration object for scanning options.</p>
										</div>
									</li>
								</ul>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scanner.html" class="tsd-signature-type">Scanner</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="applyimagesettings" class="tsd-anchor"></a>
				<h3>apply<wbr>Image<wbr>Settings</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">apply<wbr>Image<wbr>Settings<span class="tsd-signature-symbol">(</span>imageSettings<span class="tsd-signature-symbol">: </span><a href="../modules/imagesettings.html" class="tsd-signature-type">ImageSettings</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scanner.html" class="tsd-signature-type">Scanner</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:126</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Applies a new set of image settings to the scanner (replacing old settings).</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>imageSettings: <a href="../modules/imagesettings.html" class="tsd-signature-type">ImageSettings</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The image configuration object to be applied to the scanner.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scanner.html" class="tsd-signature-type">Scanner</a></h4>
						<p>The updated <a href="scanner.html">Scanner</a> object.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">apply<wbr>Scan<wbr>Settings<span class="tsd-signature-symbol">(</span>scanSettings<span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scanner.html" class="tsd-signature-type">Scanner</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:110</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Applies a new set of scan settings to the scanner (replacing old settings).</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:253</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:97</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Stop the internal <tt>WebWorker</tt> and destroy the scanner itself; ensuring complete cleanup.</p>
							</div>
							<p>This method should be called after you don&#39;t plan to use the scanner anymore,
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="isbusyprocessing" class="tsd-anchor"></a>
				<h3>is<wbr>Busy<wbr>Processing</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Busy<wbr>Processing<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:216</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
						<p>Whether the scanner is currently busy processing an image.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:223</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
						<p>Whether the scanner has loaded the external Scandit Engine library and is ready to scan.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<h3>on<wbr>Ready</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">on<wbr>Ready<span class="tsd-signature-symbol">(</span>listener<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scanner.html" class="tsd-signature-type">Scanner</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:237</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Add the listener function to the listeners array for the &quot;ready&quot; event, fired when the external
								Scandit Engine library has been loaded and the scanner can thus start to scan barcodes.</p>
							</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="processimage" class="tsd-anchor"></a>
				<h3>process<wbr>Image</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">process<wbr>Image<span class="tsd-signature-symbol">(</span>imageData<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Uint8ClampedArray</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/scanresult.html" class="tsd-signature-type">ScanResult</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanner.ts:151</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Process a given image using the previously set scanner and image settings,
								recognizing codes and retrieving the result as a list of barcodes (if any).</p>
							</div>
							<p>Multiple requests done without waiting for previous results will be queued and handled in order.</p>
							<p>Depending on the current image settings, given <i>imageData</i> and scanning execution, any of the following errors
							could be the rejected result of the returned promise:</p>
							<ul>
								<li><tt>NoImageSettings</tt></li>
								<li><tt>ImageSettingsDataMismatch</tt></li>
								<li><tt>ScanditEngineError</tt>
								</li>
							</ul>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>imageData: <span class="tsd-signature-type">Uint8ClampedArray</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The image data given as a byte array, complying with the previously set image settings.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/scanresult.html" class="tsd-signature-type">ScanResult</a><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>A promise resolving to the <a href="../interfaces/scanresult.html">ScanResult</a> object.</p>
					</li>
				</ul>
			</section>
		</section>
