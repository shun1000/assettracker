...
<head>
	...
	<title>ScanSettings | Scandit Barcode Scanner SDK for the Web</title>
		...
		<li class="current tsd-kind-class tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#disablesymbologies" class="tsd-kind-icon">disable<wbr>Symbologies</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#enablesymbologies" class="tsd-kind-icon">enable<wbr>Symbologies</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#getcodeduplicatefilter" class="tsd-kind-icon">get<wbr>Code<wbr>Duplicate<wbr>Filter</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#getmaxnumberofcodesperframe" class="tsd-kind-icon">get<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#getsearcharea" class="tsd-kind-icon">get<wbr>Search<wbr>Area</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#getsymbologysettings" class="tsd-kind-icon">get<wbr>Symbology<wbr>Settings</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#issymbologyenabled" class="tsd-kind-icon">is<wbr>Symbology<wbr>Enabled</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#setcodeduplicatefilter" class="tsd-kind-icon">set<wbr>Code<wbr>Duplicate<wbr>Filter</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#setmaxnumberofcodesperframe" class="tsd-kind-icon">set<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#setsearcharea" class="tsd-kind-icon">set<wbr>Search<wbr>Area</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="scansettings.html#tojsonstring" class="tsd-kind-icon">toJSONString</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A configuration object for scanning options.</p>
				</div>
				<p>Modified ScanSettings need to be applied to a scanner via
				<a href="barcodepicker.html#applyscansettings">BarcodePicker.applyScanSettings</a> or <a href="scanner.html#applyscansettings">Scanner.applyScanSettings</a> to take effect.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">ScanSettings</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#disablesymbologies" class="tsd-kind-icon">disable<wbr>Symbologies</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#enablesymbologies" class="tsd-kind-icon">enable<wbr>Symbologies</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#getcodeduplicatefilter" class="tsd-kind-icon">get<wbr>Code<wbr>Duplicate<wbr>Filter</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#getmaxnumberofcodesperframe" class="tsd-kind-icon">get<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#getsearcharea" class="tsd-kind-icon">get<wbr>Search<wbr>Area</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#getsymbologysettings" class="tsd-kind-icon">get<wbr>Symbology<wbr>Settings</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#issymbologyenabled" class="tsd-kind-icon">is<wbr>Symbology<wbr>Enabled</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#setcodeduplicatefilter" class="tsd-kind-icon">set<wbr>Code<wbr>Duplicate<wbr>Filter</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#setmaxnumberofcodesperframe" class="tsd-kind-icon">set<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#setsearcharea" class="tsd-kind-icon">set<wbr>Search<wbr>Area</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="scansettings.html#tojsonstring" class="tsd-kind-icon">toJSONString</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Scan<wbr>Settings<span class="tsd-signature-symbol">(</span>__namedParameters<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:15</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a ScanSettings instance.</p>
							</div>
						</div>
							...
							<li>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter">
										<h5>code<wbr>Duplicate<wbr>Filter<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;0</div>
											...
											When the same code (data/symbology) is scanned within the specified interval it is filtered out as a duplicate.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										<h5>enabled<wbr>Symbologies<span class="tsd-signature-symbol">: </span><a href="../enums/barcode.symbology.html#ean13" class="tsd-signature-type">EAN13</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#ean8" class="tsd-signature-type">EAN8</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#upca" class="tsd-signature-type">UPCA</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#upce" class="tsd-signature-type">UPCE</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#code128" class="tsd-signature-type">CODE128</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#code39" class="tsd-signature-type">CODE39</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#code93" class="tsd-signature-type">CODE93</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#interleaved_2_of_5" class="tsd-signature-type">INTERLEAVED_2_OF_5</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#qr" class="tsd-signature-type">QR</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#data_matrix" class="tsd-signature-type">DATA_MATRIX</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#pdf417" class="tsd-signature-type">PDF417</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#msi_plessey" class="tsd-signature-type">MSI_PLESSEY</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#gs1_databar" class="tsd-signature-type">GS1_DATABAR</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#gs1_databar_expanded" class="tsd-signature-type">GS1_DATABAR_EXPANDED</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#codabar" class="tsd-signature-type">CODABAR</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#aztec" class="tsd-signature-type">AZTEC</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#two_digit_add_on" class="tsd-signature-type">TWO_DIGIT_ADD_ON</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#five_digit_add_on" class="tsd-signature-type">FIVE_DIGIT_ADD_ON</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#maxicode" class="tsd-signature-type">MAXICODE</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#code11" class="tsd-signature-type">CODE11</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#gs1_databar_limited" class="tsd-signature-type">GS1_DATABAR_LIMITED</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#code25" class="tsd-signature-type">CODE25</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#micro_pdf417" class="tsd-signature-type">MICRO_PDF417</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#rm4scc" class="tsd-signature-type">RM4SCC</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#kix" class="tsd-signature-type">KIX</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html#dotcode" class="tsd-signature-type">DOTCODE</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">&gt;</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;[]</div>
												The single symbology or list/set of symbologies
											that should be initialized as enabled for recognition.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										<h5>max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;1</div>
											The maximum number of barcodes to be recognized every frame.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										<h5>search<wbr>Area<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;{ x: 0, y: 0, width: 1.0, height: 1.0 }</div>
											The area of the image in which barcodes are searched.</p>
										</div>
										<ul class="tsd-parameters">
											<li class="tsd-parameter">
						...
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="disablesymbologies" class="tsd-anchor"></a>
				<h3>disable<wbr>Symbologies</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">disable<wbr>Symbologies<span class="tsd-signature-symbol">(</span>symbology<span class="tsd-signature-symbol">: </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:132</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Disable recognition of a symbology or list/set of symbologies.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>symbology: <a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The single symbology or list/set of symbologies to disable.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
						<p>The updated <a href="scansettings.html">ScanSettings</a> object.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="enablesymbologies" class="tsd-anchor"></a>
				<h3>enable<wbr>Symbologies</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">enable<wbr>Symbologies<span class="tsd-signature-symbol">(</span>symbology<span class="tsd-signature-symbol">: </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:122</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Enable recognition of a symbology or list/set of symbologies.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>symbology: <a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol"> | </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The single symbology or list/set of symbologies to enable.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="getcodeduplicatefilter" class="tsd-anchor"></a>
				<h3>get<wbr>Code<wbr>Duplicate<wbr>Filter</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Code<wbr>Duplicate<wbr>Filter<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:142</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>When the filter is set to -1, each unique code is only scanned once. When set to 0,
								duplicate filtering is disabled. Otherwise the duplicate filter specifies an interval in milliseconds.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">number</span></h4>
						<p>The code duplicate filter value.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="getmaxnumberofcodesperframe" class="tsd-anchor"></a>
				<h3>get<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:164</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">number</span></h4>
						<p>The maximum number of barcodes to be recognized every frame.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="getsearcharea" class="tsd-anchor"></a>
				<h3>get<wbr>Search<wbr>Area</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Search<wbr>Area<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/searcharea.html" class="tsd-signature-type">SearchArea</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:183</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/searcharea.html" class="tsd-signature-type">SearchArea</a></h4>
						<p>The area of the image in which barcodes are searched.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="getsymbologysettings" class="tsd-anchor"></a>
				<h3>get<wbr>Symbology<wbr>Settings</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Symbology<wbr>Settings<span class="tsd-signature-symbol">(</span>symbology<span class="tsd-signature-symbol">: </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="symbologysettings.html" class="tsd-signature-type">SymbologySettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:93</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Get the configuration object for a symbology (which can then be modified).</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>symbology: <a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The symbology for which to retrieve the configuration.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="symbologysettings.html" class="tsd-signature-type">SymbologySettings</a></h4>
						<p>The symbology configuration object for the specified symbology.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="issymbologyenabled" class="tsd-anchor"></a>
				<h3>is<wbr>Symbology<wbr>Enabled</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Symbology<wbr>Enabled<span class="tsd-signature-symbol">(</span>symbology<span class="tsd-signature-symbol">: </span><a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:110</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Get the recognition enabled status for a symbology.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>symbology: <a href="../enums/barcode.symbology.html" class="tsd-signature-type">Symbology</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The symbology for which to retrieve the recognition enabled status.</p>
								</div>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="setcodeduplicatefilter" class="tsd-anchor"></a>
				<h3>set<wbr>Code<wbr>Duplicate<wbr>Filter</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">set<wbr>Code<wbr>Duplicate<wbr>Filter<span class="tsd-signature-symbol">(</span>durationMilliseconds<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:155</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Set the code duplicate filter value.</p>
							</div>
							<p>When the filter is set to -1, each unique code is only scanned once. When set to 0,
							duplicate filtering is disabled. Otherwise the duplicate filter specifies an interval in milliseconds.</p>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The new value (-1, 0, or positive integer).</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="setmaxnumberofcodesperframe" class="tsd-anchor"></a>
				<h3>set<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">set<wbr>Max<wbr>Number<wbr>OfCodes<wbr>Per<wbr>Frame<span class="tsd-signature-symbol">(</span>limit<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:174</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Set the maximum number of barcodes to be recognized every frame.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The new value (non-zero positive integer).</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="setsearcharea" class="tsd-anchor"></a>
				<h3>set<wbr>Search<wbr>Area</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">set<wbr>Search<wbr>Area<span class="tsd-signature-symbol">(</span>searchArea<span class="tsd-signature-symbol">: </span><a href="../interfaces/searcharea.html" class="tsd-signature-type">SearchArea</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:193</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Set the area of the image in which barcodes are searched.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>searchArea: <a href="../interfaces/searcharea.html" class="tsd-signature-type">SearchArea</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The new search area.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="scansettings.html" class="tsd-signature-type">ScanSettings</a></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				<a name="tojsonstring" class="tsd-anchor"></a>
				<h3>toJSONString</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">toJSONString<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in lib/scanSettings.ts:56</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
						<p>The configuration object as a JSON string.</p>
					</li>
				</ul>
			</section>
		</section>
