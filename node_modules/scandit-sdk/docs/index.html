...
<head>
	...
	<title>Scandit Barcode Scanner SDK for the Web | Scandit Barcode Scanner SDK for the Web</title>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="scandit-barcode-scanner-sdk-for-the-web-beta-">Scandit Barcode Scanner SDK for the Web (Beta)</h1>
			...
			<!-- /TOC -->
			<h2 id="getting-started-web-application">Getting Started - Web Application</h2>
			...
			<p>You can use the <a href="https://unpkg.com">UNPKG</a> or <a href="https://jsdelivr.com">jsDelivr</a> CDN to easily include our (latest) library as follows:</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/scandit-sdk"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- or --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			<p>A specific version of the library (example for 1.4.6) can also be included with:</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/scandit-sdk@1.4.6"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- or --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/scandit-sdk@1.4.6"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			...
			<p>Via NPM:</p>
			<pre><code class="lang-bash">npm install scandit-sdk --save
</code></pre>
			<p>Via Yarn:</p>
			<pre><code class="lang-bash">yarn add scandit-sdk
</code></pre>
			<p>Include as <a href="https://github.com/umdjs/umd">UMD module</a> (this is most probably what you need):</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/node_modules/scandit-sdk/build/browser/index.min.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			<p>Include as <a href="https://jakearchibald.com/2017/es-modules-in-browsers/">ES module</a>:</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"module"</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/node_modules/scandit-sdk/build/browser/index.esm.min.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			<p>Non-minified modules are also available if needed: just include the non-&quot;.min&quot; file.</p>
			<p>The library will then be accessible via the <code>ScanditSDK</code> object.</p>
			...
			<ul>
				...
				<li><a href="https://developer.mozilla.org/docs/Web/JavaScript/Reference/Statements/import">ES6 module</a> - <code>build/module</code></li>
			</ul>
			...
			<p>ES2015 (ES6):</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { * <span class="hljs-keyword">as</span> ScanditSDK } <span class="hljs-keyword">from</span> <span class="hljs-string">"scandit-sdk"</span>;
</code></pre>
			<p>CommonJS:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> ScanditSDK = <span class="hljs-built_in">require</span>(<span class="hljs-string">"scandit-sdk"</span>);
</code></pre>
			<p>With ES imports it&#39;s also possible to use single components. For example:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { Barcode, BarcodePicker, ScanSettings, configure } <span class="hljs-keyword">from</span> <span class="hljs-string">"scandit-sdk"</span>;
</code></pre>
			...
			<pre><code class="lang-typescript">ScanditSDK.configure(licenseKey: <span class="hljs-built_in">string</span>, {
  engineLocation: <span class="hljs-built_in">string</span> = <span class="hljs-string">"/"</span>,
  preloadEngineLibrary: <span class="hljs-built_in">boolean</span> = <span class="hljs-literal">false</span>,
  preloadCameras: <span class="hljs-built_in">boolean</span> = <span class="hljs-literal">false</span>
})
</code></pre>
			...
			<p>The next (often required) optional configuration option is the location of the Scandit Engine library location (external WebAssembly files): <code>scandit-engine-sdk.min.js</code> and <code>scandit-engine-sdk.wasm</code>. WebAssembly requires these separate files which are loaded by our main library at runtime. They can be found inside the <code>build</code> folder in the library you either download or access via a CDN; if you download the library, these files should be put in a path that&#39;s accessible to be downloaded by the running library script. The configuration option that you provide should then point to the folder containing these files, either as a path of your website or an absolute URL (like the CDN one). By default the library will look at the root of your website. If you use the CDN to access the library, you will want to set this to <code>&quot;https://unpkg.com/scandit-sdk/build&quot;</code>, <code>&quot;https://cdn.jsdelivr.net/npm/scandit-sdk/build&quot;</code>, or similar. Please ensure that the version of the main library that you set up in the &quot;Getting Started&quot; section corresponds to the version of the external Scandit Engine library retrieved via the <code>engineLocation</code> option. This is particularly important if you make use of a CDN: the version pointed at should be in both cases either the latest available one or the same specific one.</p>
			<p>The following configuration options lets you decide if you would like to eagerly load the external Scandit Engine library and/or the available cameras as soon as this function is called (by default they are not). The library load could take some time due to the download size and performance needed to prepare the external library, while the camera load could also take some time and ask the user for camera access permissions if needed. The required loads can be made later on via <code>ScanditSDK.loadEngineLibrary()</code> and <code>ScanditSDK.CameraAccess.getCameras()</code>, or are made later on when needed, if never done before.</p>
			<p>A configuration call could look as follows:</p>
			<pre><code class="lang-javascript">ScanditSDK.configure(<span class="hljs-string">"LICENSE_KEY_HERE"</span>, {
  <span class="hljs-attr">engineLocation</span>: <span class="hljs-string">"build/"</span>
			...
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"scandit-barcode-picker"</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"max-width: 1280px; max-height: 80%;"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
</code></pre>
			...
			<p>JavaScript:</p>
			<pre><code class="lang-javascript">ScanditSDK.BarcodePicker.create(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">"scandit-barcode-picker"</span>), {
  ...
  <span class="hljs-comment">// barcodePicker is ready here to be used (rest of the tutorial code should go here)</span>
			...
			<p>Typescript:</p>
			<pre><code class="lang-typescript">BarcodePicker.create(<span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">"scandit-barcode-picker"</span>), {
  ...
  <span class="hljs-comment">// barcodePicker is ready here to be used (rest of the tutorial code should go here)</span>
			...
			<p>JavaScript:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> scanSettings = <span class="hljs-keyword">new</span> ScanditSDK.ScanSettings({
...
barcodePicker.applyScanSettings(scanSettings);
			...
			<p>TypeScript:</p>
			<pre><code class="lang-typescript"><span class="hljs-keyword">const</span> scanSettings = <span class="hljs-keyword">new</span> ScanSettings({
  enabledSymbologies: [
...
barcodePicker.applyScanSettings(scanSettings);
			...
			<p>JavaScript:</p>
			<pre><code class="lang-javascript">barcodePicker.onScan(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">scanResult</span>) </span>{
  alert(scanResult.barcodes.reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">string, barcode</span>) </span>{
    <span class="hljs-keyword">return</span> string + ScanditSDK.Barcode.Symbology.toHumanizedName(barcode.symbology) + <span class="hljs-string">": "</span> + barcode.data + <span class="hljs-string">"\n"</span>;
			...
			<p>TypeScript:</p>
			<pre><code class="lang-typescript">barcodePicker.onScan(<span class="hljs-function">(<span class="hljs-params">scanResult</span>) =&gt;</span> {
  alert(scanResult.barcodes.reduce(<span class="hljs-function">(<span class="hljs-params"><span class="hljs-built_in">string</span>, barcode</span>) =&gt;</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-built_in">string</span> + <span class="hljs-string">`<span class="hljs-subst">${Barcode.Symbology.toHumanizedName(barcode.symbology)}</span>: <span class="hljs-subst">${barcode.data}</span>\n`</span>;
			...
			<p>Via NPM:</p>
			<pre><code class="lang-bash">npm install http-server -g
</code></pre>
			<p>Via Yarn:</p>
			<pre><code class="lang-bash">yarn global add http-server
</code></pre>
			<p>Run the new package from the folder containing <code>example.html</code> with:</p>
			<pre><code class="lang-bash">http-server
</code></pre>
			<p><em>Please note that this simple server will not compress files thus resulting in slower loading times than normal.</em></p>
			<p>Finally, access the webpage via your favourite (and supported) browser at <code>http://127.0.0.1:8080/example.html</code>!</p>
			<h2 id="browser-support-and-requirements">Browser Support and Requirements</h2>
			...
			<ul>
				...
				<li><a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia">MediaDevices/getUserMedia</a> - <a href="https://caniuse.com/#feat=stream">current support?</a></li>
			...
			<ul>
				<li><p>HTTPS deployment</p>
					<p>You must serve your final web application / website via HTTPS: due to browser security restrictions, camera access is only granted if that&#39;s the case; this is not needed for local IP addresses during development.</p>
				</li>
				<li><p>WASM file format</p>
					<p>Please make sure that your webserver serves the <code>scandit-engine-sdk.wasm</code> file with <code>Content-Type: binary/octet-stream</code> (it should be the default), failure to do so will result in some browsers failing to execute the external library.</p>
				</li>
				...
				<li><p>Library performance</p>
					...
					<ul>
						<li>Ensure the JavaScript assets and the <code>scandit-engine-sdk.min.js</code> and <code>scandit-engine-sdk.wasm</code> files are served compressed and with caching enabled by your web server. Note that most CDN services do not offer compression!</li>
						<li>Re-use <code>BarcodePicker</code> objects whenever possible by hiding and showing them instead of destroying and recreating them: each object needs to load and initialize the external library on creation.</li>
						<li>If possible, create a (hidden and paused) <code>BarcodePicker</code> in the background and simply resume scanning by switching its visibility to &quot;show&quot; when needed, instead of creating it on the fly to provide instant scanning capabilities.</li>
						...
						<li>Camera permissions can be asked to the user in advance via this library or other external methods to ensure a more fluid experience depending on the situation. Remember that usually these permissions are stored forever and need only to be asked once.</li>
					</ul>
				</li>
				<li><p>Scandit logo</p>
				...
				<li><p>iOS 11.2.2 / 11.2.5 support</p>
					<p>Apple released iOS version 11.2.2 on January 8, 2018, as an emergency update meant to mitigate the effects of the widespread <em>Spectre</em> vulnerability. This update also included changes related to <em>WebKit</em> and the <em>Safari</em> browser, as documented <a href="https://webkit.org/blog/8048/what-spectre-and-meltdown-mean-for-webkit/">here</a>. Unfortunately this update also introduced a critical <em>WebAssembly</em> bug, which causes this and many other libraries relying on this technology to randomly crash and fail to access memory with <code>Out of bounds memory access</code> or <code>None: abort(6)</code> errors on iOS versions 11.2.2 and 11.2.5. This problem cannot be solved by us or other library developers; the issue has already been reported to Apple by multiple sources and a fix for it is expected to be released soon. In the meantime we suggest to conditionally use the library or show alerts to the affected users by utilizing the OS version information available in the browser via the <em>user agent</em> string.</p>
				</li>
			</ul>
			...
			<h2 id="faq">FAQ</h2>
			<ul>
				<li><p>How big is the library?</p>
					<p>The main library is currently about 60kB (minified, gzipped), while the external Scandit Engine library is around 40kB + 1MB (JS + WASM, gzipped). Keep in mind that you will not need to wait for these files to download to display your webpage / web application, they can be downloaded and prepared in the background without affecting the rest of the application (the Scandit Engine library is also always automatically downloaded and prepared asynchronously in a separate thread).</p>
				</li>
				<li><p>Why is only Safari supported on iOS?</p>
					<p>This is (for now) a limitation imposed by Apple, which doesn&#39;t yet allow any external browser using WKWebView from accessing device cameras, see <a href="https://forums.developer.apple.com/thread/88052">this discussion</a>.</p>
				</li>
				<li><p>How well are barcodes recognized?</p>
					<p>This obviously depends from the specifics of the camera being used, but in general the performance of this library is slightly inferior to what is provided by Scandit&#39;s native SDKs. Currently it&#39;s not possible to (efficiently) use WebGL instructions inside WebWorkers, meaning no advanced GPU control and functions can be provided to our library. The situation will also improve over time as more of the features present in the native SDK are implemented/enabled and as browsers allow more control over the GPU and camera.</p>
				</li>
				<li><p>Does the library require network access?</p>
					<p>The scanning of barcodes doesn&#39;t require network access and is executed completely on the client in the browser. Our engine however needs network access at configuration time to verify license keys and will also attempt to send additional requests afterwards for data analytics purposes (linked to your license key).</p>
				</li>
				<li><p>Why can I see network requests with a 409 error response in the browser&#39;s debugger?</p>
					<p>That is normal behaviour and won&#39;t affect final users in any way: it&#39;s our Scandit Engine library contacting our servers for verification for a device that is already registered and thus is allowed to use the library with the given license key. Note that it&#39;s not a JavaScript error but just a network response result that is displayed by Chrome by default in the debugger view (when set to show network responses).</p>
				</li>
				<li><p>Why can I sometimes see &quot;Intervention&quot; messages about blocked vibrate calls in the browser&#39;s debugger?</p>
					<p>That is normal behaviour and won&#39;t affect final users in any way: some browsers won&#39;t allow vibration requests to be called by our library if the user hasn&#39;t first touched/clicked the page, and will block these calls (outside from normal JavaScript code execution).</p>
				</li>
				<li><p>Why does my BarcodePicker/Scanner not work/start?</p>
					<p>Please ensure that you correctly configured the library via the <code>ScanditSDK.configure</code> function call before using the objects provided. More specifically check that in its arguments:</p>
					<ul>
						<li>You provided a valid license key (any domain name restriction will work for local testing).</li>
						<li>You configured the <code>engineLocation</code> setting appropriately for your folder/deployment structure.</li>
					</ul>
				</li>
				<li><p>Why do I randomly get &quot;Out of bounds memory access&quot; or &quot;None: abort(6)&quot; errors?</p>
					<p>This is most likely caused by a iOS 11.2.2 / 11.2.5 <em>Safari</em> browser, due to <em>WebKit</em> memory access problems introduced by this specific iOS version by Apple, as indicated in the <a href="#important-notes">Important Notes</a> section. This is unfortunately out of our control, but a fix for it is expected to be released by the responsible browser/OS teams soon.</p>
				</li>
			</ul>
			...
			<p>Start developing (watch task for build and tests):</p>
			<pre><code class="lang-bash">yarn watch
</code></pre>
			<p>Build and create all output modules:</p>
			<pre><code class="lang-bash">yarn build
</code></pre>
			<p>Lint with type checking:</p>
			<pre><code class="lang-bash">yarn lint
</code></pre>
			<p>Run unit tests and check coverage:</p>
			<pre><code class="lang-bash">yarn unit
</code></pre>
			<p>Generate documentation:</p>
			<pre><code class="lang-bash">yarn docs
</code></pre>
			<p>Show all available commands:</p>
			<pre><code class="lang-bash">yarn info
</code></pre>
			<h2 id="versioning-and-changelog">Versioning and Changelog</h2>
			<p>We use <a href="https://semver.org/">SemVer</a> for versioning. A log of the project&#39;s releases over time with their features and changes can be found in the <a href="CHANGELOG.md">CHANGELOG.md</a> file.</p>
			...
			<p>This project is licensed under a custom license - see the <a href="LICENSE">LICENSE</a> file for details.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-module tsd-is-external"><a href="modules/barcode.html" class="tsd-kind-icon">Barcode</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/camera.html" class="tsd-kind-icon">Camera</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/cameraaccess.html" class="tsd-kind-icon">Camera<wbr>Access</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/camerasettings.html" class="tsd-kind-icon">Camera<wbr>Settings</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/imagesettings.html" class="tsd-kind-icon">Image<wbr>Settings</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Classes</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-is-external"><a href="classes/barcodepicker.html" class="tsd-kind-icon">Barcode<wbr>Picker</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/parser.html" class="tsd-kind-icon">Parser</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/scansettings.html" class="tsd-kind-icon">Scan<wbr>Settings</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/scanner.html" class="tsd-kind-icon">Scanner</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/symbologysettings.html" class="tsd-kind-icon">Symbology<wbr>Settings</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/barcodeencodingrange.html" class="tsd-kind-icon">Barcode<wbr>Encoding<wbr>Range</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/parserfield.html" class="tsd-kind-icon">Parser<wbr>Field</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/parserresult.html" class="tsd-kind-icon">Parser<wbr>Result</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/point.html" class="tsd-kind-icon">Point</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/quadrilateral.html" class="tsd-kind-icon">Quadrilateral</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/scanresult.html" class="tsd-kind-icon">Scan<wbr>Result</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/searcharea.html" class="tsd-kind-icon">Search<wbr>Area</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function"><a href="globals.html#configure" class="tsd-kind-icon">configure</a></li>
							<li class="tsd-kind-function"><a href="globals.html#loadenginelibrary" class="tsd-kind-icon">load<wbr>Engine<wbr>Library</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">configure<span class="tsd-signature-symbol">(</span>licenseKey<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, __namedParameters<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in index.ts:77</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Initialize and configure the Scandit Barcode Scanner SDK library. This function must be called as first thing
								before using any other function of the library.</p>
							</div>
							...
							<ul>
								...
								<li><tt>InternalError</tt>
								</li>
							</ul>
							<p>If the external Scandit Engine library is not loaded now, it can later be loaded via <a href="globals.html#loadenginelibrary">loadEngineLibrary</a>,
							or it will be downloaded and prepared automatically when needed by other objects/functions.</p>
							<p>If the cameras are not accessed now, they can later be loaded via <a href="modules/cameraaccess.html#getcameras">CameraAccess.getCameras</a>,
							or they will be accessed automatically when needed by other objects/functions.</p>
						</div>
							...
							<li>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter">
										<h5>engine<wbr>Location<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;&quot;/&quot;</div>
											...
											Can be a full URL to folder or an absolute folder path.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										<h5>preload<wbr>Cameras<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;false</div>
											Whether to eagerly request access (if needed) and access available cameras with this call.</p>
										</div>
									</li>
									<li class="tsd-parameter">
										<h5>preload<wbr>Engine<wbr>Library<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5>
										<div class="tsd-comment tsd-typography">
											<p><div class="tsd-signature-symbol">Default =&nbsp;false</div>
											Whether to eagerly download and prepare the external Scandit Engine library with this call.</p>
										</div>
									</li>
								</ul>
							</li>
						...
						<p>A promise resolving when the library has loaded and the available cameras are loaded (if selected).</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="loadenginelibrary" class="tsd-anchor"></a>
				<h3>load<wbr>Engine<wbr>Library</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">load<wbr>Engine<wbr>Library<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in index.ts:143</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Download and prepare in memory the external Scandit Engine library.
									If this method isn&#39;t called manually the library will be automatically loaded the first
								time it&#39;s required by another of this library&#39;s components.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>A promise resolving when the external Scandit Engine library has been loaded and is ready.</p>
					</li>
				</ul>
			</section>
		</section>
