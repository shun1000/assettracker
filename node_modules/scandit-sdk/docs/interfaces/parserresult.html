...
<head>
	...
	<title>ParserResult | Scandit Barcode Scanner SDK for the Web</title>
...
<nav class="tsd-navigation secondary"><ul><li class=" tsd-kind-module tsd-is-external"><a href="../modules/barcode.html" class="tsd-kind-icon">Barcode</a></li><li class=" tsd-kind-module tsd-is-external"><a href="../modules/camera.html" class="tsd-kind-icon">Camera</a></li><li class=" tsd-kind-module tsd-is-external"><a href="../modules/cameraaccess.html" class="tsd-kind-icon">CameraAccess</a></li><li class=" tsd-kind-module tsd-is-external"><a href="../modules/camerasettings.html" class="tsd-kind-icon">CameraSettings</a></li><li class=" tsd-kind-module tsd-is-external"><a href="../modules/imagesettings.html" class="tsd-kind-icon">ImageSettings</a></li></ul>
	<ul>
		...
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="barcodeencodingrange.html" class="tsd-kind-icon">Barcode<wbr>Encoding<wbr>Range</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="parserfield.html" class="tsd-kind-icon">Parser<wbr>Field</a>
		</li>
		<li class="current tsd-kind-interface tsd-is-external">
			<a href="parserresult.html" class="tsd-kind-icon">Parser<wbr>Result</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="parserresult.html#fields" class="tsd-kind-icon">fields</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="parserresult.html#fieldsbyname" class="tsd-kind-icon">fields<wbr>ByName</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="parserresult.html#jsonstring" class="tsd-kind-icon">json<wbr>String</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
		...
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="quadrilateral.html" class="tsd-kind-icon">Quadrilateral</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="scanresult.html" class="tsd-kind-icon">Scan<wbr>Result</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="searcharea.html" class="tsd-kind-icon">Search<wbr>Area</a>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A result of a successfully parsed data string.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">ParserResult</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="parserresult.html#fields" class="tsd-kind-icon">fields</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="parserresult.html#fieldsbyname" class="tsd-kind-icon">fields<wbr>ByName</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="parserresult.html#jsonstring" class="tsd-kind-icon">json<wbr>String</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<h3>fields</h3>
				<div class="tsd-signature tsd-kind-icon">fields<span class="tsd-signature-symbol">:</span> <a href="parserfield.html" class="tsd-signature-type">ParserField</a><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in lib/parserResult.ts:15</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The fields contained in the result as an array of <a href="parserfield.html">ParserField</a> objects.
						The order of the fields in array depends on the order of the fields in the input data.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				<a name="fieldsbyname" class="tsd-anchor"></a>
				<h3>fields<wbr>ByName</h3>
				<div class="tsd-signature tsd-kind-icon">fields<wbr>ByName<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in lib/parserResult.ts:20</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The fields contained in the result as a map of <a href="parserfield.html">ParserField</a> objects.
						The entries in the map are field names pointing to the parser field.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-index-signature">
							<h5><span class="tsd-signature-symbol">[</span>fieldName: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="parserfield.html" class="tsd-signature-type">ParserField</a></h5>
						</li>
					</ul>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				<a name="jsonstring" class="tsd-anchor"></a>
				<h3>json<wbr>String</h3>
				<div class="tsd-signature tsd-kind-icon">json<wbr>String<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in lib/parserResult.ts:10</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The result object as a serialized JSON string.</p>
					</div>
				</div>
			</section>
		</section>
