...
var SymbologySettings = /** @class */ (function () {
    ...
    function SymbologySettings(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.enabled, enabled = _c === void 0 ? false : _c, _d = _b.colorInvertedEnabled, colorInvertedEnabled = _d === void 0 ? false : _d, _e = _b.activeSymbolCounts, activeSymbolCounts = _e === void 0 ? [] : _e, _f = _b.extensions, extensions = _f === void 0 ? null : _f, _g = _b.checksums, checksums = _g === void 0 ? null : _g;
    ...
    SymbologySettings.prototype.enableExtensions = function (extension) {
        ...
        if (typeof extension === "object") {
            this.extensions = new Set(this.extensions.concat(Array.from(extension).filter(function (e) {
    ...
    SymbologySettings.prototype.disableExtensions = function (extension) {
        if (typeof extension === "object") {
            this.extensions = new Set(this.extensions.slice().filter(function (x) {
    ...
    SymbologySettings.prototype.enableChecksums = function (checksum) {
        ...
        if (typeof checksum === "object") {
            this.checksums = new Set(this.checksums.concat(Array.from(checksum).filter(function (c) {
                return (c in SymbologySettings.Checksum || Object.values(SymbologySettings.Checksum).indexOf(c.toLowerCase()) !== -1);
            })));
        }
        else {
    ...
    SymbologySettings.prototype.disableChecksums = function (checksum) {
        if (typeof checksum === "object") {
            this.checksums = new Set(this.checksums.slice().filter(function (x) {
