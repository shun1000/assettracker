...
ava_1.test("constructor", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
    t["false"](ss.enabled);
...
ava_1.test("isEnabled & setEnabled", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("isColorInvertedEnabled & setColorInvertedEnabled", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("getActiveSymbolCounts & setActiveSymbolCounts", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("setActiveSymbolCountsRange", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("getEnabledExtensions & enableExtensions & disableExtensions", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("getEnabledExtensions & enableExtensions & disableExtensions (strings)", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("getEnabledChecksums & enableChecksums & disableChecksums", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
...
ava_1.test("getEnabledChecksums & enableChecksums & disableChecksums (strings)", function (t) {
    var ss = new scandit_sdk_1.SymbologySettings();
